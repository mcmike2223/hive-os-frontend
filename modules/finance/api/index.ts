...
export const financeApi = {
  ...
  createCostCenter: async (payload: Payload) => (await api.post("/finance/settings/cost-centers", payload)).data,
  updateCostCenter: async (id: number, payload: Payload) => (await api.patch(`/finance/settings/cost-centers/${id}`, payload)).data,
